...
class Map(object):
    def __init__(self):
        ...
        self.sorntop_minonka = Entity(model = "sorntop", texture = "sorntop", collider = "mesh", tag = "sorntop", position = (2000, 60, 100))
        self.sornhill_minonka = Entity(model = "sornhill", texture = "sornhill", collider = "mesh", tag = "sornhill", position = (2000, 60, 100))
